...
(function () {
  ...
  const MacroProvider = ({ children }) => {
      const [macros, setMacros] = reactExports.useState(loadMacros());
  ...
  const AddMacroModal = ({ onClose }) => {
      ...
      return (jsxRuntimeExports.jsx("div", { style: {
              ...
              }, children: [jsxRuntimeExports.jsx("h3", { children: "Add Macro" }), jsxRuntimeExports.jsx("input", { placeholder: "Macro name", value: name, onChange: e => setName(e.target.value), style: { width: '100%', marginBottom: 10, padding: 10, borderRadius: 8 } }), jsxRuntimeExports.jsx("textarea", { placeholder: "JavaScript code", value: code, onChange: e => setCode(e.target.value), rows: 5, style: { width: '100%', padding: 10, borderRadius: 8 } }), jsxRuntimeExports.jsxs("div", { style: { marginTop: 10, display: 'flex', justifyContent: 'flex-end', gap: '10px' }, children: [jsxRuntimeExports.jsx("button", { onClick: handleSubmit, children: "Save" }), jsxRuntimeExports.jsx("button", { onClick: onClose, children: "Cancel" })] })] }) }));
  };
  ...
  const MacroPrompt = () => {
      ...
      if (!visible)
          return null;
      return (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [showModal && jsxRuntimeExports.jsx(AddMacroModal, { onClose: () => setShowModal(false) }), jsxRuntimeExports.jsxs("div", { style: {
                      position: 'fixed',
                      top: '50%',
                      left: '50%',
                      ...
                      alignItems: 'center',
                      gap: '10px',
                  }, children: [jsxRuntimeExports.jsx("input", { autoFocus: true, value: input, onChange: e => setInput(e.target.value), onKeyDown: e => {
                              if (e.key === 'Enter')
                                  runMacro(input.trim());
                              if (e.key === 'Escape')
                                  setVisible(false);
                          }, placeholder: "Type a macro...", style: {
                              padding: '14px 16px',
                              fontSize: '18px',
                              width: '400px',
                              borderRadius: '12px',
                          ...
                          } }), jsxRuntimeExports.jsx("button", { onClick: () => setShowModal(true), title: "Add Macro", style: {
                              width: '48px',
                              height: '48px',
                              fontSize: '24px',
                              borderRadius: '50%',
